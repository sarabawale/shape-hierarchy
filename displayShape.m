% GITHUB FUNCTION - with minor adjustments
% This function plots the given shape, colored with annotations in case the
% annot input is indicated
function displayShape(shape,annot)
    ...
    axis equal
    axis off
    hold off; % added to ensure creation of individual PNG files
end
